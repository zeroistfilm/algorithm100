...
def calibrate_camera(nx, ny, basepath):
    ...
    images = glob.glob(path.join(basepath, '*.jpg'))          # <------------------ 수정
...
if __name__ == "__main__":
    ...
    nx, ny = 6, 4  # number of grids along x and y axis in the chessboard pattern             # <------------------------- 수정
    basepath = "C:/Users/yd/Downloads/Capture/a"  # path contain the calibration images              #<-----------------------수정
